...
export default function LayoutDirectorioHorizontal({ 
    ...
    return (
        <div className="flex flex-col h-screen w-screen overflow-hidden relative" style={{ backgroundColor: fondo }}>
            ...
            <header className="h-24 flex justify-between items-center px-10 shrink-0 z-20 bg-black/50 backdrop-blur-md border-b border-white/10">
                <img src={config.logo} alt="Logo" className="h-16 w-auto object-contain" />
                <div className="px-8 py-2 rounded-full border border-white/10 bg-white/5 shadow-lg">
            ...
            <main className="flex-1 px-10 py-6 flex flex-col gap-6 overflow-hidden">
                <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <div className="flex-1 overflow-hidden flex flex-col gap-4 mt-2">
                        {visibles.map((e, i) => (
                            <div key={i} className="grid grid-cols-12 gap-4 items-center p-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl animate-fade-in-up">
                                
                                {/* HORARIO CORREGIDO: Todo en un bloque balanceado */}
                                <div className="col-span-3 flex flex-col items-center justify-center border-r border-white/10 py-1">
                                    <div className="flex items-center gap-3 bg-black/20 px-4 py-1 rounded-full border border-white/5">
                                ...
                                <div className="col-span-6 flex items-center gap-6 pl-6 min-w-0">
                                    <div className="h-20 w-32 rounded-xl overflow-hidden shrink-0 border-2 border-white/10 shadow-lg bg-black/20">
                                ...
                                <div className="col-span-3 flex items-center justify-end gap-6 pr-4">
                                    <span className="text-sm font-black uppercase bg-white/10 px-5 py-2 rounded-xl border border-white/10" style={{ color: texto_reloj }}>
                                        {e.nombre_salon}
                                    </span>
                ...
                {/* FOOTER WIDGETS CON FONDO OSCURO */}
                <div className="h-60 shrink-0 grid grid-cols-2 gap-8 mb-4">
                    ...
                    <div className="relative rounded-[2.5rem] overflow-hidden border border-white/20 bg-black/50 backdrop-blur-lg flex flex-col shadow-2xl">
            ...
            <footer className="h-14 border-t border-white/10 px-10 flex justify-between items-center shrink-0 bg-black/40 backdrop-blur-md">
