    ...
    return (
        <div className={`flex flex-col items-center justify-center ${color} ${size}`}>
            ...
            <div 
                ...
                className="transition-transform duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] p-1" // Efecto elástico suave
            >
                {/* Flecha Gruesa (Thick Arrow) */}
                <svg 
                ...
                >
                    {/* Trazo grueso tipo señalización */}
